...
import br.edu.ifrn.bancodedados.TurmaDao;
...
public class TelaCadastroTurma extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        cbSerie.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "1", "2", "3", "4" }));
    ...
    private void btCadastreActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btCadastreActionPerformed
        Turma turma = new Turma((String) cbCurso.getSelectedItem(), (int) cbSerie.getSelectedItem(), (String) cbTurno.getSelectedItem());
